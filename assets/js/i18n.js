...
(function () {
  ...
  // --- Storefront (ecommerce) UI strings — merged in, no existing keys touched ---
  Object.assign(DICT, {
    nav_shop: ["Shop", "শপ"],
    sc_cart: ["Cart", "কার্ট"],
    sc_search_hint: ["Search by plant name, type or benefit — try “money plant” or “air-purifying”.", "গাছের নাম, ধরন বা উপকারিতা দিয়ে খুঁজুন — যেমন “money plant” বা “air-purifying”।"],
    sc_add: ["Add to cart", "কার্টে যোগ করুন"],
    sc_from: ["From", "শুরু"],
    sc_options: ["Select options", "অপশন বাছুন"],
    pdp_choose: ["Choose an option", "একটি অপশন বাছুন"],
    pdp_variant_oos: ["out of stock", "স্টকে নেই"],
    sc_added: ["Added ✓", "যোগ হয়েছে ✓"],
    sc_oos: ["Out of stock", "স্টকে নেই"],
    sc_notify: ["Notify me", "খবর দিন"],
    sc_from: ["From", "শুরু"],
    sc_order_wa: ["Order on WhatsApp", "হোয়াটসঅ্যাপে অর্ডার করুন"],
    sc_remove: ["Remove", "সরান"],
    sc_qty: ["Quantity", "সংখ্যা"],
    shop_title: ["Shop plants", "গাছ কিনুন"],
    shop_sub: ["Grown in Bengal, delivered across India.", "বাংলায় বড় হওয়া, সারা ভারতে ডেলিভারি।"],
    shop_all: ["All plants", "সব গাছ"],
    shop_results: ["plants", "গাছ"],
    shop_filters: ["Filters", "ফিল্টার"],
    shop_sort: ["Sort", "সাজান"],
    sort_featured: ["Featured", "ফিচার্ড"],
    sort_low: ["Price: low to high", "দাম: কম → বেশি"],
    sort_high: ["Price: high to low", "দাম: বেশি → কম"],
    shop_clear: ["Clear all", "সব মুছুন"],
    shop_instock: ["In stock only", "শুধু স্টকে আছে"],
    shop_category: ["Category", "বিভাগ"],
    shop_price: ["Price", "দাম"],
    shop_size: ["Size", "সাইজ"],
    shop_traits: ["Good for", "উপযোগী"],
    shop_goal: ["Shop by goal", "প্রয়োজন অনুযায়ী"],
    shop_none: ["No plants match these filters.", "এই ফিল্টারে কোনো গাছ মেলেনি।"],
    pdp_about: ["About this plant", "এই গাছ সম্পর্কে"],
    pdp_care: ["Care", "যত্ন"],
    pdp_light: ["Light", "আলো"],
    pdp_water: ["Water", "জল"],
    pdp_maint: ["Care level", "যত্নের মাত্রা"],
    pdp_growth: ["Growth", "বৃদ্ধি"],
    pdp_mature: ["Mature size", "পূর্ণ আকার"],
    pdp_container: ["Container", "টবে"],
    pdp_inout: ["Indoor / Outdoor", "ঘরে / বাইরে"],
    pdp_botanical: ["Botanical name", "বৈজ্ঞানিক নাম"],
    pdp_size: ["Size", "সাইজ"],
    pdp_ship_note: ["Grown & shipped from our Dankuni nursery. Delivery confirmed on WhatsApp.", "আমাদের ডানকুনি নার্সারি থেকে পাঠানো। ডেলিভারি হোয়াটসঅ্যাপে কনফার্ম করা হবে।"],
    pdp_related: ["You may also like", "এগুলোও ভালো লাগতে পারে"],
    pdp_facts: ["Quick facts", "এক নজরে"],
    pdp_care_head: ["How to care for it", "যত্ন কীভাবে নেবেন"],
    deliv_confirm: ["Delivery is confirmed on WhatsApp after we check your PIN code.", "পিন কোড দেখে হোয়াটসঅ্যাপে ডেলিভারি কনফার্ম করা হয়।"],
    deliv_local: ["From our Dankuni nursery: ₹29 within 2 km · ₹49 within 4 km · ₹79 within 10 km · ₹99 beyond.", "আমাদের ডানকুনি নার্সারি থেকে: ২ কিমিতে ₹২৯ · ৪ কিমিতে ₹৪৯ · ১০ কিমিতে ₹৭৯ · তার বেশি হলে ₹৯৯।"],
    deliv_far: ["Or collect free from our nursery.", "অথবা নার্সারি থেকে বিনামূল্যে সংগ্রহ করুন।"],
    deliv_time: ["Delivery time: up to 5–7 business days.", "ডেলিভারি সময়: সর্বোচ্চ ৫–৭ কর্মদিবস।"],
    pdp_desc: ["Description", "বিবরণ"],
    pdp_more_img: ["More photos coming soon", "আরও ছবি শীঘ্রই আসছে"],
    cart_title: ["Your cart", "আপনার কার্ট"],
    cart_empty: ["Your cart is empty.", "আপনার কার্ট খালি।"],
    cart_browse: ["Browse plants", "গাছ দেখুন"],
    cart_subtotal: ["Subtotal", "মোট"],
    cart_discount: ["Discount", "ছাড়"],
    cart_delivery: ["Delivery", "ডেলিভারি"],
    cart_delivery_tbd: ["Confirmed on WhatsApp", "হোয়াটসঅ্যাপে জানানো হবে"],
    cart_total: ["Total (excl. delivery)", "সর্বমোট (ডেলিভারি ছাড়া)"],
    cart_coupon_ph: ["Coupon code", "কুপন কোড"],
    cart_apply: ["Apply", "প্রয়োগ করুন"],
    cart_your_details: ["Your details", "আপনার তথ্য"],
    ord_name: ["Full name", "পুরো নাম"],
    ord_phone: ["Phone number", "ফোন নম্বর"],
    ord_wa_same: ["WhatsApp number is the same", "হোয়াটসঅ্যাপ নম্বর একই"],
    ord_wa: ["WhatsApp number", "হোয়াটসঅ্যাপ নম্বর"],
    ord_address: ["Delivery address", "ডেলিভারি ঠিকানা"],
    ord_pin: ["PIN code", "পিন কোড"],
    ord_landmark: ["Landmark (optional)", "ল্যান্ডমার্ক (ঐচ্ছিক)"],
    ord_notes: ["Order notes (optional)", "অর্ডার নোট (ঐচ্ছিক)"],
    cart_order_wa: ["Order on WhatsApp", "হোয়াটসঅ্যাপে অর্ডার করুন"],
    cart_order_hint: ["We'll confirm stock & delivery on WhatsApp.", "স্টক ও ডেলিভারি হোয়াটসঅ্যাপে কনফার্ম করব।"]
  });
